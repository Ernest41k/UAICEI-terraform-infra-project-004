...
# CREATING INBOUND RULE FOR JUPITER SERVER SECURITY GROUP --------------------------------------------------------------
resource "aws_vpc_security_group_ingress_rule" "allow_ssh_for_dev_server" {
...
# CREATING OUTBOUND RULE FOR JUPITER SERVER SECURITY GROUP--------------------------------------------------------
